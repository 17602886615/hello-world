    ...
    'components' => [
        ...
        'rbac' => [
            ...
            'noNeedAuthentication' => [
                ...
                'debug/default/view',
                'site/get-province',//省份数据
                'site/today-datas',//今日数据接口
                'site/agenty-sales',//运营中心销量排名（本月前五）
                'site/agentf-sales',//服务中心销量排名（本月前五）
                'site/dev-distribution',//设备分布情况
                'site/real-time-datas',//实时数据
                'site/user-type-sales',//用户类型和销量占比
                'site/line-datas',//折线图数据
                'dev-manager/map',//地图模式
                'dev-manager/get-markers',//地图坐标
                'admin-user/get-agent',//获取运营中心
                'admin-user/search-area-center',//获取片区中心
            ],
        ],
        'i18n' => [
            'translations' => [
