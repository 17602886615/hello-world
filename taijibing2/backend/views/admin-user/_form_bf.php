...
<div class="row">
    <div class="col-sm-12">
        <div class="ibox" style='padding:20px;'>
            <div style="text-align: right;margin-bottom: 10px;margin-top: 20px;margin-right: 15px;"> <?= \yii\bootstrap\Html::a('返回',['admin-user/index'],['class'=>'btn btn-info'])?></div>
...
//        $('#shopcoord').val(JSON.stringify(point));
    ...
    function init(){
        ...
        if(data=='服务中心'&&role_id!=3){//运营中心登陆不执行
