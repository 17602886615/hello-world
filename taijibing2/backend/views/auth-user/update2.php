    ...
    <div class="col-sm-12">
        <div class="ibox">
            ...
            <div class="ibox-content">
                ...
                <?= $form->field($model['model'], 'LoginName')->textInput(['maxlength' => 12])->label('登陆账号') ?>
                ...
                <div class="item"  style="margin-bottom: 15px">
                    ...
                    <div class="fcontent" style="padding-left: 0">
                        ...
                        <input type="button"  class="btn select_btn" style="height: 26px;margin-bottom: 5px;line-height: 15px;margin-left: 0px" value="+标记位置" onclick="openMark()"/>
                        <span>经度：</span>
