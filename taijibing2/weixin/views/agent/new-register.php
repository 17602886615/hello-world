        ...
        <div class="mui-slider-item">
          <!-- 具体内容 -->
            <div class='info'>
               ...
               <p style="display: none"  id="remark"></p> 
...
<script type="text/html" id="tea_html">
...
#submit_tea{
width:80%;height: 30px;;color:#fff;border:none;background: #ccc;
}
    </style>
          <div class='tea_head' style="">
         ...
         <div class="tea_body">
               ...
               <div id="tea_center" style="    padding:0px 10%;">
                    
                      <p style=" float: left;width: 100%;    position: relative;"><span>绿茶</span>
                        <input type="checkbox" name="selected" value="绿茶"  id="Green_tea" class="state">
                        <label for="Green_tea"></label>
                      </p>
                       <p style=" float: left;width: 100%;    position: relative;"><span>乌龙茶</span>
                        <input type="checkbox" name="selected"  value="乌龙茶"  id="Black_tea" class="state">
                        <label for="Black_tea"></label>
                      </p>
                      <p style=" float: left;width: 100%;    position: relative;"><span>红茶</span>
                        <input type="checkbox" name="selected" value="红茶"  id="Scented_tea" class="state">
                        <label for="Scented_tea"></label>
                      </p>
                      <p style=" float: left;width: 100%;    position: relative;"><span>黑茶</span>
                        <input type="checkbox" name="selected" value="黑茶"  id="Oolong_tea" class="state">
                        <label for="Oolong_tea"></label>
                      </p>
                      <p style=" float: left;width: 100%;    position: relative;"><span>黄茶</span>
                        <input type="checkbox" name="selected" value="黄茶"  id="Puer_tea" class="state">
                        <label for="Puer_tea"></label>
                      </p>
                      <p style=" float: left;width: 100%;    position: relative;"><span>白茶</span>
                        <input type="checkbox" name="selected" value="白茶"  id="Healthcare_tea" class="state">
                        <label for="Healthcare_tea"></label>
                      </p>
                      <p style=" float: left;width: 100%;    position: relative;"><span>其他</span>
                        <input type="checkbox" name="selected" value="其他"  id="Herbal_tea" class="state">
                        <label for="Herbal_tea"></label>
                      </p>
                        <p style=" float: left;width: 100%;    position: relative;margin-bottom:20px"><span>
                          较少/不喝茶</span>
                        <input type="checkbox" name="selected" value="较少/不喝茶"  id="no_tea" class="state">
                        <label for="no_tea"></label>
                      </p>
               </div>
               <div style="text-align: center;margin-top:20px">

                 <input type="button" id="submit_tea" value="确定" style="">
...
function tea_html_functi(argument) {
  // body...
         layer.open({
              type: 1
              ,content:$("#tea_html").html()
              ,anim: 'up'
              ,style: 'position:fixed; bottom:0; left:0; width: 100%;  padding:10px 0; border:none;height:100%;overflow:auto'
        });

          $('input[type="checkbox"]').click(function(){
         var teaString =  queryCheckedValue() ;
         // alert(teaString)
           if(teaString!=''){
              $("#submit_tea").css('background','url(/static/images/brnW.png) 0% 0% / 100% 100% no-repeat')
           }

          })
         // $("#userHeadText p[agentname="+OneVal+"]").remove();

       $("#submit_tea").click(function function_name() {
  ...
  var num =  $("#tea_center input:checkbox[name='selected']:checked").length;
  var str = "";
  $("#tea_center input:checkbox[name='selected']:checked").each(function(i) {
...
<script type="text/javascript" src="/static/js/new-register/new-register.js?v=4.4"></script>
<script>
$(function(){
